...
[0]
[0,0,0,0,0,0,0,0]
Stack was empty. So, we found no element for which T[i]could be assigned as next warmer day. So, just pushed current day 0to stack
1
74
[1]
[1,0,0,0,0,0,0,0]
...
📝 Dry Run
Again, consider T = [73,74,75,71,69,72,76,73] and we get the following steps listed in table
i/ cur
T[i]
stack
ans
...
[7]
[0,0,0,0,0,0,0,0]
Stack was empty. So, we found no next warmer element for T[i]. Assign ans[7] = 0and push current day 7to stack
6
76
[6]
[0,0,0,0,0,0,0,0]
