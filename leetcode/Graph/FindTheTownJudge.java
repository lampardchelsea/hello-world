...
*/
// Solution 1: Indegree - outdegree
// Refer to
//  https://leetcode.com/problems/find-the-town-judge/discuss/312565/JAVA%3A-Simple-and-Concise-solution-with-detailed-explanation
/**
  core logic: use two integer arrays to represent the inward and outward connections on the node
  after storing all values into the two arrays just go through those two arrays and find the person 
  with 0 outward connections and being N-1 inward connections
*/
class Solution {
