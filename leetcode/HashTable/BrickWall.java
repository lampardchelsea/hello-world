 ...
 * We want to cut from the edge of the most common location among all the levels, hence using a map to record the 
 * locations and their corresponding occurrence. Most importantly, Mexico will pay for it! (I wish)
*/
public class Solution {
    public int leastBricks(List<List<Integer>> wall) {
        ...
        for(List<Integer> list : wall) {
            int length = 0;
            // "-1" is for exclude the right boundary
