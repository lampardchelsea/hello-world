...
Style 2: if condition instead of while loop
class Solution {
    public int equalSubstring(String s, String t, int maxCost) {
        int maxLen = 0;
        int cost = 0;
...
Why we can use 'if' instead of 'while loop' ?
Refer to L1838.Frequency of the Most Frequent Element (Ref.L2968) Approach 2 explain
