...
In this problem, a natural approach would be to create one line of length 
maxWidth at a time. We can split creating a line into two subtasks:
...
Take the words from the first task and create a lineWe have a list of words 
line. Now, we need to convert it to a string according to the problem description:
