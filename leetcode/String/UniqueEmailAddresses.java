...
class Solution {
    public int numUniqueEmails(String[] emails) {
        ...
        for(String email : emails) {
            ...
            // Don't forget to add "@" back, should not directly connect
            // local name and domain name directly
            // e.g ["test.email+alex@leetcode.com","test.email.leet+alex@code.com"]
            result.add(localName + "@" + tokens[1]);
        }
        return result.size();
    }
}
