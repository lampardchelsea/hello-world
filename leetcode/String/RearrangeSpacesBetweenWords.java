...
is maximized. If you cannot redistribute all the spaces equally, place the extra spaces at the end, meaning the returned 
...
class Solution {
    public String reorderSpaces(String text) {
        ...
        // Test case: "a" -> "a" means if only 1 word, no space need
