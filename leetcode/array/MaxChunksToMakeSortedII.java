...
First question, what is the largest number of chunks for an array given the length as n? it's simple, just n, namely every single element makes up the single-element chunk. For a given array, the largest number of chunks happens when it is increasing and every element is already at the right place.[0, 1, 3, 4] => [0, 1], [3], [4]
