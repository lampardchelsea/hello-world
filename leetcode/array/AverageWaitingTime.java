...
// Solution 1:
// Refer to
// https://leetcode.com/problems/average-waiting-time/discuss/987328/JavaC++Python-Straight-Forward/799975
class Solution {
    public double averageWaitingTime(int[][] customers) {
        ...
        for(int[] customer : customers) {
            ...
            start_prepare = Math.max(arrival, start_prepare);
            total_wait += prepare_time + (start_prepare - arrival);
            start_prepare += prepare_time;
        }
